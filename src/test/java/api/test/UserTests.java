...
public class UserTests {
	...
	
	{
		...
		Response res=UserEndpoints.createUser(payload); // Here we called "UserEndpoints" class and createUser method and passed body present in "payload" variable as an argument
	...
	public void testgetUserByName()
	{
		...
		Response res=UserEndpoints.getUser(this.payload.getUsername()); // By using this keyword we can refer to the payload and using getter method we get the username from the payload
		res.then().log().all();
		Assert.assertEquals(res.getStatusCode(),200);
	...
	public void testupdateuserByName()
	{
		...
		Response resafterUpdate=UserEndpoints.getUser(this.payload.getUsername()); // By using this keyword we can refer to the payload and using getter method we get the username from the payload
